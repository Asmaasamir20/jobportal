  ...
  return (
    <div className='px-4 sm:px-5 my-12 sm:my-20 overflow-hidden'>
        <div className='relative bg-gradient-to-r from-violet-50 to-purple-50 p-6 sm:p-12 lg:p-24 xl:p-32 rounded-lg overflow-hidden max-w-full'> 
            ...
            <img className='absolute w-32 sm:w-48 lg:w-64 xl:w-80 right-0 sm:right-4 lg:right-8 bottom-0 max-lg:opacity-30 lg:opacity-100 pointer-events-none' src={assets.app_main_img} alt="Mobile App" />
        </div>
    </div>
  )
}
